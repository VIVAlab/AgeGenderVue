...
LBPHISTOGRAM::LBPHISTOGRAM(){
    ...
    DEFAULT_BLOCK_SIZE = 10; //height and width of the block to be LBPu'd
    DEFAULT_NUM_BLOCKS = 10; //There will be 100 10x10 blocks for a 100x100 size image; 10 blocks for the height and width each
    XL_eye=64;
    XR_eye=134;
    YL_eye=66;
    YR_eye=66;
...
Mat LBPHISTOGRAM::rotate(Mat *image_input, int x_1, int y_1, int x_2, int y_2, int length )
{
    ...
    Mat ROI;
    if((new_x_1-XL_eye>=0) && (new_y_1-YL_eye >=0) && (new_x_1-XL_eye+200<scaled_img.cols) &&(new_y_1-YL_eye+200<scaled_img.rows)){
        ROI=scaled_img(Rect(new_x_1-XL_eye,new_y_1-YL_eye,200,200));
